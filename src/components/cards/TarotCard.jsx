  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <img src={backImage} alt="Verso da Carta de Tarot" className="w-full h-full object-contain" />
        </div>
        ...
        >
          <img src={image} alt={`Carta: ${name}`} className="w-full h-full object-contain" />
